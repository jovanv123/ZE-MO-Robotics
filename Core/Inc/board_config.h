...
#define RIGHT_LEADSCREW_OPEN 0
#define RIGHT_LEADSCREW_CLOSED 140

#define LEFT_LEADSCREW_OPEN 150
#define LEFT_LEADSCREW_CLOSED 295

#define BACK_ROTATOR_OPENED 125
#define BACK_ROTATOR_CLOSED 60
